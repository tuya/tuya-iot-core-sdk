...
mqtt_client_status_t mqtt_client_init(void* client, const mqtt_client_config_t* config)
{
	...
	int ret = network_tls_init(&context->network, 
        &(const TLSConnectParams){
            ...
            .client_cert = context->config.client_cert,
            .client_cert_len = context->config.client_cert_len,
            .client_key = context->config.client_key,
            .client_key_len = context->config.client_key_len,
