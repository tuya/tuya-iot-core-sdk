...
const tuya_endpoint_t default_endpint_pro[] = {
    {.region = "AY", .mqtt = {"m1.tuyacn.com", 8883}},
    {.region = "AZ", .mqtt = {"m1.tuyaus.com", 8883}},
    {.region = "EU", .mqtt = {"m1.tuyaeu.com", 8883}},
    {.region = "IN", .mqtt = {"m1.tuyain.com", 8883}},
    {.region = "UE", .mqtt = {"m1-ueaz.tuyaus.com", 8883}},
};

const tuya_endpoint_t default_endpint_pr_0[] = {
    {.region = "AY", .mqtt = {"m1-cn.wgine.com", 8883}},
    {.region = "AZ", .mqtt = {"m1-us.wgine.com", 8883}},
    {.region = "EU", .mqtt = {"m1-eu.wgine.com", 8883}},
    {.region = "IN", .mqtt = {"m1-ind.wgine.com", 8883}},
    {.region = "UE", .mqtt = {"m1-ueaz.wgine.com", 8883}},
};
...
int tuya_endpoint_update()
{
    ...
    if (endpoint_mgr.endpoint.mqtt.cert != NULL &&
        endpoint_mgr.endpoint.mqtt.cert != default_tuya_cacert) {
        TY_LOGV("Free endpoint already exist cert.");
        system_free(endpoint_mgr.endpoint.mqtt.cert);
    }
